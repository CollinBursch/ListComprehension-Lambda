...
list = comprised of = expression/ transformation, iteration, condition (optional)
...
# 1 Using a list comprehension, create a new list called "newlist"
# out of the list "numbers",
# which contains only the positive numbers from the list, as integers.

numbers = [34.6, -203.4, 44.9, 68.3, -12.2, 44.6, 12.7]
newlist = [i.numbers(i) for i in numbers >= 0]
print(newlist)
...
x = [i for i in range(1000) in i < 5000]
